export const ControllerIcon = () => {
  return (
    ...
    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_930_2150"/>
    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_930_2150" result="shape"/>
    </filter>
    </defs>
    </svg>
