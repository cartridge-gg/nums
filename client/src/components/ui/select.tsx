...
>(({ className, children, onSelect, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Item
      ref={ref}
      className={cn(
        "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none text-white focus:bg-mauve-500 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        className,
      )}
