...
pub impl Private of PrivateTrait {
    ...
    fn title() -> ByteArray {
        "<g transform='translate(187,0)'><path d='M0 0 H426 V104 C426 126 408 144 386 144 H40 C18 144 0 126 0 104 V0 Z' fill='#8F8F8F' /><text x='213' y='78' font-size='72' text-anchor='middle' dominant-baseline='middle' fill='white' filter='url(#dropShadow)' >COMPLETE</text></g>"
    }
}
