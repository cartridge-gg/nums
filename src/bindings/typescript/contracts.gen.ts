...
export function setupWorld(provider: DojoProvider) {
  const build_MockNumsToken_allowance_calldata = (
    owner: string,
    spender: string
  ): DojoCall => {
    return {
  ...
  const MockNumsToken_allowance = async (owner: string, spender: string) => {
    try {
      return await provider.call(
        "nums",
        build_MockNumsToken_allowance_calldata(owner, spender)
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_MockNumsToken_approve_calldata = (
    spender: string,
    amount: BigNumberish
  ): DojoCall => {
    return {
  ...
  const MockNumsToken_approve = async (
  ...
  const build_MockNumsToken_balanceOf_calldata = (
    account: string
  ): DojoCall => {
    return {
      contractName: "MockNumsToken",
  ...
  const MockNumsToken_balanceOf = async (account: string) => {
    try {
      return await provider.call(
        "nums",
        build_MockNumsToken_balanceOf_calldata(account)
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const MockNumsToken_decimals = async () => {
    try {
      return await provider.call(
        "nums",
        build_MockNumsToken_decimals_calldata()
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const MockNumsToken_totalSupply = async () => {
    try {
      return await provider.call(
        "nums",
        build_MockNumsToken_totalSupply_calldata()
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_MockNumsToken_transfer_calldata = (
    recipient: string,
    amount: BigNumberish
  ): DojoCall => {
    return {
  ...
  const MockNumsToken_transfer = async (
    snAccount: Account | AccountInterface,
    recipient: string,
    amount: BigNumberish
  ) => {
  ...
  const build_MockNumsToken_transferFrom_calldata = (
    sender: string,
    recipient: string,
    amount: BigNumberish
  ): DojoCall => {
  ...
  const MockNumsToken_transferFrom = async (
    snAccount: Account | AccountInterface,
    sender: string,
    recipient: string,
    amount: BigNumberish
  ...
  const build_MockRewardToken_allowance_calldata = (
    owner: string,
    spender: string
  ): DojoCall => {
    return {
  ...
  const MockRewardToken_allowance = async (owner: string, spender: string) => {
    try {
      return await provider.call(
        "nums",
        build_MockRewardToken_allowance_calldata(owner, spender)
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_MockRewardToken_approve_calldata = (
    spender: string,
    amount: BigNumberish
  ): DojoCall => {
    return {
  ...
  const MockRewardToken_approve = async (
    snAccount: Account | AccountInterface,
    spender: string,
    amount: BigNumberish
  ) => {
  ...
  const build_MockRewardToken_balanceOf_calldata = (
    account: string
  ): DojoCall => {
    return {
      contractName: "MockRewardToken",
  ...
  const MockRewardToken_balanceOf = async (account: string) => {
    try {
      return await provider.call(
        "nums",
        build_MockRewardToken_balanceOf_calldata(account)
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const MockRewardToken_totalSupply = async () => {
    try {
      return await provider.call(
        "nums",
        build_MockRewardToken_totalSupply_calldata()
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_MockRewardToken_transfer_calldata = (
    recipient: string,
    amount: BigNumberish
  ): DojoCall => {
    return {
  ...
  const MockRewardToken_transfer = async (
    snAccount: Account | AccountInterface,
    recipient: string,
    amount: BigNumberish
  ) => {
  ...
  const build_MockRewardToken_transferFrom_calldata = (
    sender: string,
    recipient: string,
    amount: BigNumberish
  ): DojoCall => {
  ...
  const MockRewardToken_transferFrom = async (
    snAccount: Account | AccountInterface,
    sender: string,
    recipient: string,
    amount: BigNumberish
  ...
  const build_config_actions_setConfig_calldata = (
  ...
  const config_actions_setConfig = async (
    snAccount: Account | AccountInterface,
    config: models.Config
  ) => {
    try {
  ...
  const build_game_actions_createGame_calldata = (
  ...
  const game_actions_createGame = async (
    snAccount: Account | AccountInterface,
    factoryId: BigNumberish
  ) => {
    try {
      return await provider.execute(
        snAccount,
        build_game_actions_createGame_calldata(factoryId),
        "nums"
      );
    } catch (error) {
      console.error(error);
  ...
  const build_game_actions_setSlot_calldata = (
    gameId: BigNumberish,
    targetIdx: BigNumberish
  ): DojoCall => {
    return {
      contractName: "game_actions",
      entrypoint: "set_slot",
  ...
  const game_actions_setSlot = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    targetIdx: BigNumberish
  ) => {
  ...
  const build_jackpot_actions_claimJackpot_calldata = (
  ...
  const jackpot_actions_claimJackpot = async (
    snAccount: Account | AccountInterface,
    jackpotId: BigNumberish
  ) => {
    try {
  ...
  const build_jackpot_actions_createJackpotFactory_calldata = (
    // @ts-ignore
    params: models.CreateJackpotFactoryParams
  ): DojoCall => {
    return {
      contractName: "jackpot_actions",
  ...
  const jackpot_actions_createJackpotFactory = async (
    snAccount: Account | AccountInterface,
    // @ts-ignore
    params: models.CreateJackpotFactoryParams
  ) => {
  ...
  const build_jackpot_actions_nextJackpot_calldata = (
    factoryId: BigNumberish
  ): DojoCall => {
    return {
      contractName: "jackpot_actions",
  ...
  const jackpot_actions_nextJackpot = async (
    snAccount: Account | AccountInterface,
    factoryId: BigNumberish
  ) => {
    try {
      return await provider.execute(
        snAccount,
        build_jackpot_actions_nextJackpot_calldata(factoryId),
        "nums"
      );
    } catch (error) {
      console.error(error);
  ...
  const build_jackpot_actions_rescueJackpot_calldata = (
    jackpotId: BigNumberish
  ): DojoCall => {
    return {
      contractName: "jackpot_actions",
  ...
  const jackpot_actions_rescueJackpot = async (
    snAccount: Account | AccountInterface,
    jackpotId: BigNumberish
  ) => {
    try {
  ...
  return {
    ...
    jackpot_actions: {
      ...
      buildCreateJackpotFactoryCalldata:
        build_jackpot_actions_createJackpotFactory_calldata,
      nextJackpot: jackpot_actions_nextJackpot,
      buildNextJackpotCalldata: build_jackpot_actions_nextJackpot_calldata,
